    ...
    <ToastContainer autoClose ={1500}/>
        ...
        <form onSubmit={handleSubmit}>
            <div className="form-group">
                ...
                <input type="text" className="form-control" id="nameInput" name="name" value={credentials.name}
            ...
            <div className="form-group">
                ...
                <input type="password" className="form-control" id="confirmPassword" name="confirmPassword" value = {credentials.confirmPassword} 
